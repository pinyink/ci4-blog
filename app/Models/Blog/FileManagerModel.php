...
class FileManagerModel extends Model
{
    ...
    protected $createdField  = 'files_created_at';
    protected $updatedField  = 'files_updated_at';
    protected $deletedField  = 'files_deleted_at';
    ...
    public $column_order  = array(null, null, 'a.files_name', 'a.files_desc', 'a.files_path');
    public $column_search = array('a.files_name', 'a.files_desc', 'a.files_path');
    public $order         = array('a.files_name' => 'asc');
    ...
    {
        $this->dt->select('a.files_id, a.files_name, a.files_desc, a.files_path');
